...
<template>
    <nav class="link">
        <ul>
            <li v-for="link in links" :key="link.Links_id.id" class="flex alignCenter gap15">
                <!-- <svg viewBox="0 0 24 24" class="frosty_fill">
                ...
                <a class="link cardText_format fontColor_light underline" :href="link.Links_id.url">{{
                    link.Links_id.title }}</a>
            </li>
        </ul>
    </nav>
</template>
